...
def send_to_n8n(
    ...
    webhook_url = "https://kiliyt.app.n8n.cloud/webhook/student-performance"
    ...
    try:
        ...
        if response.ok:
            print("SUCCESS: Data reached n8n Webhook")
        else:
            print("ERROR: n8n rejected the request")

    except Exception as e:

        print("ERROR CONNECTING TO N8N:")
        print(e)
# ============================================================
# PREDICT FUNCTION
# ============================================================
...
def savetoexcel():
    ...
    attendance = float(attid.get())
    studyhours = float(sthrid.get())
    internalmarks = float(iatid.get())
    assignment = float(assid.get())
    previousscore = float(previd.get())

    filename = "student data.xlsx"

    # Calculate study score
    study_score = (studyhours / 8) * 100
    ...
    # Get prediction
    current_prediction = prediction.cget("text")
